 ...
 *
 * p12e (2026-09-07) re-anchored `warden_eater`'s *authored* HP down (365000
 * -> 18250) to cancel `baseHpMul`'s 20x, so the roster no longer reaches this
 * magnitude at T1 today — the case below still pins the fix at the magnitude
 * that exposed it, not at whatever the boss's HP happens to be this week.
 *
