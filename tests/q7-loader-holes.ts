...
export const ACCEPTED: Readonly<Record<string, readonly string[]>> = {
  ...
  'vsupgrades.skillCards.necromancer[].maxRank': ['negative', 'zero', 'infinite', 'fractional'],
  'vsupgrades.skillCards.necromancer[].name': ['to-string', 'empty-string'],
  'vsupgrades.skillCards.necromancer[].perRank': ['negative', 'zero', 'infinite', 'fractional'],
  'vsupgrades.skillCards.paladin[].desc': ['to-string', 'empty-string'],
  'vsupgrades.skillCards.paladin[].key': ['to-string', 'empty-string'],
  'vsupgrades.skillCards.paladin[].maxRank': ['negative', 'zero', 'infinite', 'fractional'],
  'vsupgrades.skillCards.paladin[].name': ['to-string', 'empty-string'],
  'vsupgrades.skillCards.paladin[].perRank': ['negative', 'zero', 'infinite', 'fractional'],
  ...
  'vsupgrades.skillCards.plaguebringer[].maxRank': ['negative', 'zero', 'infinite', 'fractional'],
  'vsupgrades.skillCards.plaguebringer[].name': ['to-string', 'empty-string'],
  'vsupgrades.skillCards.plaguebringer[].perRank': ['negative', 'zero', 'infinite', 'fractional'],
  'vsupgrades.skillCards.pyromancer[].desc': ['to-string', 'empty-string'],
  'vsupgrades.skillCards.pyromancer[].key': ['to-string', 'empty-string'],
  'vsupgrades.skillCards.pyromancer[].maxRank': ['negative', 'zero', 'infinite', 'fractional'],
  'vsupgrades.skillCards.pyromancer[].name': ['to-string', 'empty-string'],
  'vsupgrades.skillCards.pyromancer[].perRank': ['negative', 'zero', 'infinite', 'fractional'],
  ...
  'vsupgrades.skillCards.stormcaller[].maxRank': ['negative', 'zero', 'infinite', 'fractional'],
  'vsupgrades.skillCards.stormcaller[].name': ['to-string', 'empty-string'],
  'vsupgrades.skillCards.stormcaller[].perRank': ['negative', 'zero', 'infinite', 'fractional'],
  'vsupgrades.skillCards.swordsman[].desc': ['to-string', 'empty-string'],
  'vsupgrades.skillCards.swordsman[].key': ['to-string', 'empty-string'],
  'vsupgrades.skillCards.swordsman[].maxRank': ['negative', 'zero', 'infinite', 'fractional'],
  'vsupgrades.skillCards.swordsman[].name': ['to-string', 'empty-string'],
  'vsupgrades.skillCards.swordsman[].perRank': ['negative', 'zero', 'infinite', 'fractional'],
  'vsupgrades.skillCards.time_lord[].desc': ['to-string', 'empty-string'],
  'vsupgrades.skillCards.time_lord[].key': ['to-string', 'empty-string'],
  'vsupgrades.skillCards.time_lord[].maxRank': ['negative', 'zero', 'infinite', 'fractional'],
  'vsupgrades.skillCards.time_lord[].name': ['to-string', 'empty-string'],
  'vsupgrades.skillCards.time_lord[].perRank': ['negative', 'zero', 'infinite', 'fractional'],
  'vsupgrades.statBoons': ['empty-array', 'drop-element', 'dupe-element'],
  'vsupgrades.statBoons[].desc': ['to-string', 'empty-string'],
  'vsupgrades.statBoons[].key': ['to-string', 'empty-string'],
  'vsupgrades.statBoons[].maxRank': ['negative', 'zero', 'infinite', 'fractional'],
  'vsupgrades.statBoons[].name': ['to-string', 'empty-string'],
  'vsupgrades.statBoons[].perRank': ['negative', 'zero', 'infinite', 'fractional'],
  'vsupgrades.statBoons[].stat': ['to-string', 'empty-string'],
  'vsupgrades.typeMastery.maxRank': ['negative', 'zero', 'infinite', 'fractional'],
  'vsupgrades.typeMastery.perRank': ['negative', 'zero', 'infinite', 'fractional'],
...
export const REF_VERDICTS: Readonly<Record<string, RefVerdict>> = {
  ...
  'vsupgrades.statBoons[].stat': 'open',
