...
export function damageEnemy(
  ...
  // fb160: the per-source-and-type matrix behind the DPS panel's segmented bars.
  const bySourceType = w.damageBySourceType[source] ?? (w.damageBySourceType[source] = {});
  bySourceType[dmgType] = (bySourceType[dmgType] ?? 0) + dmgBooked;
