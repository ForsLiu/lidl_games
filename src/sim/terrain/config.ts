...
import { GATE_JITTER_MARGIN } from './gates';
 ...
 * ceiling below, a sweep, `jitterDomainCoreAnchorRange`) must be able to pass
 * one in rather than always re-deriving the static layout's own count.
 */
