# docs/BACKLOG-DONE.md — archived completed work (append-only)

Moved out of the live `BACKLOG.md`/`BACKLOG-*.md` files by fb178
(feedback/feature-token-economy.md) to keep the live queue readable.
Content is preserved verbatim in original order; nothing here should be
edited except to append the next archival pass.
