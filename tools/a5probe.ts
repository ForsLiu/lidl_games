...
export const BUILDS: BuildSpec[] = [
  ...
  { name: 'frost-heavy', classKey: 'frost_warden', towerKeys: ['frost_obelisk', 'arrow_spire'], wallRatio: 0.25 },
  ...
  { name: 'frost-mix', classKey: 'frost_warden', towerKeys: ['frost_obelisk', 'arrow_spire', 'ballista', 'mortar', 'venom_spore'], wallRatio: 0.25 },
